...
### Features 📄
   ...
   - **Bootstrap:** Added to the project via `index.html` (stylesheet link and JavaScript link in *head* tag). The dropdown is a Bootstrap UI component, and its colors update with the active theme.
